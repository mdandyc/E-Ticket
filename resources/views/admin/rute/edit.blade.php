...
@endif
    ...
    <div class="form-group">
        ...
        <input type="text" name="rute_form" placeholder="Rute Form" class="form-control" value="{{$rute->rute_form}}">
    </div>
    <div class="form-group">
        <label>Rute To</label>
        <input type="text" name="rute_to" placeholder="Rute To" class="form-control" value="{{$rute->rute_to}}">
    </div>
    <div class="form-group">
        <label>Depart At</label>
        <input type="text" name="depart_at" placeholder="Depart At" class="form-control" value="{{$rute->depart_at}}">
    </div>
    <div class="form-group">
        <label>Price</label>
        <input type="text" name="price" placeholder="Price" class="form-control" value="{{$rute->price}}">
    </div>
    <div class="form-group">
        ...
        <select name="transportation_id" id="" class="form-control">
        	...
        	@if($data->id == $rute->transportation_id)
        	selected
        	@endif 
        	>{{$data->code}}</option>
        	@endforeach
