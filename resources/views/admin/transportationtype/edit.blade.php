...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
<form action="/admin/transportasitype/{{$transportationtype->id}}" method="POST">
@if ($errors->any())
...
@endif
    ...
    <div class="form-group">
        <input type="text" name="description" class="form-control" placeholder="Jenis Transpotation" value="{{$transportationtype->description}}">
    </div>
