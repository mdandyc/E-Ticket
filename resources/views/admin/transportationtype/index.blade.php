...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        List Detail
        <small><a href="/admin/transportasitype/create" class="btn btn-default">Input</a></small>
        <small><a href="/admin/transportasitype/pdf" class="btn btn-default">Make a Report!</a></small>
      </h1>
    </section>
    ...
    @foreach ($transportationtype as $data)
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">Jenis Transportasi - 
                <a href="/admin/transportasitype/{{$data->id}}">{{$data->description}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <div class="box-body">
			  <p><b>ID : </b>{{$data->id}}</p>
              <p><b>Jenis Transportasi : </b>{{$data->description}}</p>

              <form action="/admin/transportasitype/{{$data->id}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/admin/transportasitype/{{$data->id}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
      ...
      <center>
      {{$transportationtype->appends(Request::only('keyword'))->links()}}
      </center>
    </section>
    <!-- /.content -->
  </div>
