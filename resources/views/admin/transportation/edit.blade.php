...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <form action="/transportasitype/search" method="get" class="sidebar-form">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        List Detail
        <small><a href="/admin/transportasi/create">Input</a></small>
      </h1>
    </section>
    ...
    <div class="container">
<form action="/admin/transportasi/{{$transportation->id}}" method="POST">
@if ($errors->any())
...
@endif
    ...
    <div class="form-group">
        <label>Kode</label>
        <input type="text" name="code" placeholder="Kode" class="form-control" value="{{$transportation->code}}">
    </div>
    <div class="form-group">
        <label>Description</label>
        <input type="text" name="description" placeholder="Description" class="form-control" value="{{$transportation->description}}">
    </div>
    <div class="form-group">
        <label>Jumlah Kursi</label>
        <input type="number" name="seat_qty" placeholder="Jumlah Kursi" class="form-control" value="{{$transportation->seat_qty}}">
    </div>
    <div class="form-group">
        <label>Jenis Transportasi</label>
        <select name="transportation_type_id" id="" class="form-control">
        	@foreach($transportationtype as $data)
        	<option value="{{$data->id}}"
        	@if($data->id == $transportation->transportation_type_id)
        	selected
        	@endif 
