...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <form action="/transportation/search" method="get" class="sidebar-form">
      ...
      {{-- @else --}}
        ...
        <li class="active">
          <a href="/admin/transportasi">
            <i class="fa fa-book"></i> <span>Transportation</span><span class="pull-right-container">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        List Detail
        <small><a href="/admin/transportasi/create" class="btn btn-default">Input</a></small>
        <small><a href="/admin/transportasi/pdf" class="btn btn-default">Make a Report!</a></small>
      </h1>
    </section>
    ...
    @foreach ($transportation as $data)
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">Kode Transportasi - 
                <a href="/admin/transportasi/{{$data->id}}">{{$data->code}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <div class="box-body">
              ...
              <p><b>Jumlah Kursi : </b>{{$data->seat_qty}}</p>
              <p><b>Jenis Transportasi : </b>{{$data->transportationtype->description}}</p>

              <form action="/admin/transportasi/{{$data->id}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/admin/transportasi/{{$data->id}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
      ...
      <center>
      {{$transportation->appends(Request::only('keyword'))->links()}}
      </center>
    </section>
    <!-- /.content -->
  </div>
