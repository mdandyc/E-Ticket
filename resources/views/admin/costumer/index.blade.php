...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <form action="/costumer/search" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active">
          <a href="/admin/costumer">
            <i class="fa fa-handshake-o"></i> <span>Costumer</span><span class="pull-right-container">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        List Detail
        <small><a href="/admin/costumer/create" class="btn btn-default">Input</a></small>
        <small><a href="/admin/costumer/pdf" class="btn btn-default">Make Report!</a></small>
      </h1>
    </section>
    ...
    @foreach ($costumer as $data)
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                <span class="username">Costumer Name -
                <a href="/admin/costumer/{{$data->id}}">{{$data->name}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <div class="box-body">
              ...
              <p><b>Users : </b>{{$data->user->username}}</p>

              <form action="/admin/costumer/{{$data->id}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/admin/costumer/{{$data->id}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
      ...
      <center>
      {{$costumer->appends(Request::only('keyword'))->links()}}
      </center>
    </section>
    <!-- /.content -->
  </div>
