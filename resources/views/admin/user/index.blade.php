...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        List Detail
        <small><a href="/admin/user/create" class="btn btn-default">Input</a></small>
        <small><a href="/admin/user/pdf" class="btn btn-default">Make a Report!</a></small>
      </h1>
    </section>
          ...
          <div class="box box-default">
            <div class="box-header with-border">
              <div class="user-block">
                ...
                <a href="/admin/user/{{$data->id}}">{{$data->username}}</a><br>
                </span>
              </div>
              <!-- /.user-block -->
            ...
            <div class="box-body">
              ...
              @if($data->costumer != null)
              <p><b>Customer : </b>{{$data->costumer->name}}</p>
              @else
              <p><b>Customer : </b>-</p>
              @endif

              <form action="/admin/user/{{$data->username}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/admin/user/{{$data->username}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
