...
@endif
    ...
    <div class="form-group">
        ...
        <input type="text" name="reservation_at" placeholder="Reservation At" class="form-control" value="{{$reservation->reservation_at}}">
    </div>
    <div class="form-group">
        <label>Reservation Date</label>
        <input type="date" name="reservation_date" placeholder="Reservation Date" class="form-control" value="{{$reservation->reservation_date}}">
    </div>
    <div class="form-group">
        ...
        <select name="costumer_id" id="" class="form-control">
        	...
        	@if($data->id == $reservation->costumer_id)
        		selected
        	@endif
        	>{{$data->name}}</option>
        	@endforeach
    ...
    <div class="form-group">
        ...
        <input type="text" name="seat_code" placeholder="Seat Code" class="form-control" value="{{$reservation->seat_code}}">
    </div>
    <div class="form-group">
        <label>Rute</label>
        <select name="rute_id" id="" class="form-control">
        	@foreach($rute as $data)
        	<option value="{{$data->id}}"
        	@if($data->id == $reservation->rute_id)
        		selected
        	@endif
        	>{{$data->rute_form}} - {{$data->rute_to}}</option>
        	@endforeach
        </select>
    </div>
    <div class="form-group">
        ...
        <select name="user_id" id="" class="form-control">
        	...
        	<option value="{{$data->id}}"
        	@if($data->id == $reservation->user_id)
        		selected
        	@endif
