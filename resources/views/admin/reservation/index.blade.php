...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <form action="/reservation/search" method="get" class="sidebar-form">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        List Detail
        <small><a href="/admin/reservation/create" class="btn btn-default">Input</a></small>
        <small><a href="/admin/reservation/pdf" class="btn btn-default">Make a Report!</a></small>
      </h1>
    </section>
    ...
    @foreach ($reservation as $data)
        <div class="col-md-6">
          ...
          <div class="box box-default">
            ...
            <!-- /.box-header -->
            <div class="box-body">
			  <p><b>Reservation At : </b>{{$data->reservation_at}}</p>
              <p><b>Reservation Date : </b>{{$data->reservation_date}}</p>
              <p><b>Nama Costumer : </b>{{$data->costumer->name}}</p>
              <p><b>Kode Kursi : </b>{{$data->seat_code}}</p>
              <p><b>Rute From : </b>{{$data->rute->rute_form}}</p>
              <p><b>Rute To : </b>{{$data->rute->rute_to}}</p>
              <p><b>Depart At : </b>{{$data->rute->depart_at}}</p>
              <p><b>Harga : </b>{{$data->rute->price}}</p>
              <p><b>Username : </b>{{$data->user->username}}</p>

              <form action="/admin/reservation/{{$data->id}}" method="post" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <input type="hidden" name="_method" value="delete">
              <input type="hidden" name="_token" value="{{csrf_token()}}">
              <a href="/admin/reservation/{{$data->id}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
